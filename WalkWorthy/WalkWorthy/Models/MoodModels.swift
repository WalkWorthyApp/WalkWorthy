...
// MARK: - Updated Profile Model

struct OnboardingProfileV2 {
    var age: Int?
    ...
    init(
        ...
        hobbies: Set<String> = [],
        optIn: Bool = true,
        checkInTimes: CheckInTimes = .defaultTimes,
...
struct RemoteUserProfileRequestV2: Codable {
    var ageRange: String?
...
// MARK: - Mood API Protocol Extension
